        ...
        if (data.success && data.data?.length > 0) {
            ...
            if (logisticsReqs.length > 0) {
                ...
                logisticsReqs.forEach(req => {
                    ...
                    html += `
                        <div style="background: #f9fafb; padding: 15px; margin-bottom: 10px; border-radius: 8px; border-left: 4px solid #fbbf24;">
                            <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                                <div style="flex: 1;">
                                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 5px;">
                                        <strong style="font-size: 16px;">${req.job_title}</strong>
                                        <span style="background: ${statusColor}; color: white; padding: 2px 10px; border-radius: 20px; font-size: 11px;">
                                            ${req.status}
                                        </span>
                                    </div>
                                    ...
                                    <div style="display: flex; gap: 15px; font-size: 12px; color: #6b7280; margin-top: 5px;">
                                        <span><i class="fas fa-users"></i> ${req.positions} position(s)</span>
                ...
                listDiv.innerHTML = '<p style="text-align: center; padding: 30px;"><i class="fas fa-inbox fa-2x"></i><br>No requisitions from logistics departments</p>';
            }
        } else {
            listDiv.innerHTML = '<p style="text-align: center; padding: 30px;"><i class="fas fa-inbox fa-2x"></i><br>No requisitions found</p>';
        }
    } catch (error) {
        listDiv.innerHTML = `<p style="text-align: center; padding: 20px; color: #ef4444;">Error loading requisitions: ${error.message}</p>`;
    }
}
