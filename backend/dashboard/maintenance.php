...
<div class="main-content">
    ...
    <?php endif; ?>
       ...
       <div class="dashboard-grid">
        ...
        <!-- Asset List & Management (ADMIN CRUD) -->
        ...
        <div class="card card-full">
            ...
            <div id="assetFormContainer" class="form-container">
                <h3>Add New Asset</h3>
                        ...
                        <?php if (!empty($assets)): ?>
                          ...
                          elseif ($condition >= 40) echo 'condition-warning';
                           ...
                           <?php echo htmlspecialchars($asset['asset_condition']); ?>%
                            ...
                            <button class="btn-icon btn-edit" onclick="editAsset(...)">
            ...
            <form method="POST" action="" class="inline-form" onsubmit="return confirm('Delete this asset?');">
                ...
                <button type="submit" class="btn-icon btn-delete">
                    <i class="fas fa-trash"></i> Delete
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="padding: 20px; text-align: center; color: #999;">No assets found. Add one to get started.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    <div class="card-body">
        ...
        <!-- Maintenance Alerts (common for all users) -->
        <div class="card">
            <div class="card-header">
    ...
    <?php endif; ?>
        ...
        <!-- Maintenance History (common for all users) -->
       <div class="card">
    <div class="card-header">
    ...
    <div class="card-body">
        <div class="timeline">
            <?php
            // Fetch last 30 days of maintenance alerts, both done and pending
            $stmt = $pdo->prepare("
                SELECT * 
            ...
            <?php if (!empty($maintenance_history)): ?>
                <?php foreach ($maintenance_history as $record): ?>
                    <?php 
                        // Determine type/color based on status or overdue
                        $type = 'blue'; // default
                        if ($record['status'] === 'done') $type = 'emerald';
                        else {
                            $dueDate = new DateTime($record['due_date']);
                            $now = new DateTime();
                            $type = ($dueDate < $now) ? 'amber' : 'blue'; // overdue = amber, upcoming = blue
                        }
    ...
    <!-- Asset Lifecycle Summary (common) -->
    <div class="card card-full">
        <div class="card-header">
